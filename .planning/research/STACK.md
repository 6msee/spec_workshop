...
**Domain:** University CMMS / AI-assisted maintenance request system (UP-Fix)
**Researched:** 2026-08-18
**Confidence:** MEDIUM (websearch-sourced, cross-checked across independent results; Anthropic model/API facts sourced from the curated `claude-api` skill = HIGH)

> **Scope note:** PHP 8.2+, Microsoft SQL Server (`pdo_sqlsrv`), vanilla JS/HTML/CSS with no build step, LINE Messaging API + LIFF, and Anthropic Claude via Guzzle are locked project decisions (university IT constraints, SPEC.md §8). This document does **not** re-litigate those choices — it validates the exact versions/patterns and calls out gaps and pitfalls specific to this combination.
...
**If the university server can only offer PHP 8.2 (not 8.3+):**
...
**If the university server is Windows/IIS instead of Linux/Nginx (SPEC.md §16, open question 7):**
...
**If Smart Services (the legacy system) is NOT on the same SQL Server instance (SPEC.md §16, open question 2):**
...
---
*Stack research for: University CMMS / AI-assisted maintenance request system*
*Researched: 2026-08-18*
